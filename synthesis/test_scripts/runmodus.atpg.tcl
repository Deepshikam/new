...
build_model \
    ...
    -designsource	 $WORKDIR/dff.test_netlist.v \
...
build_testmode \
    -testmode	 FULLSCAN \
    -assignfile	 $WORKDIR/dff.FULLSCAN.pinassign \
    -modedef	 FULLSCAN \
...
check_log log_create_logic_tests_FULLSCAN_dff_atpg
...
check_log log_write_vectors_FULLSCAN_dff_atpg
...
check_log log_commit_tests_FULLSCAN_dff_atpg
