...
//***************************************************************************//
//                                                                           //
//  FILE CREATED..............May 08, 2024 at 17:16:09                       //
//                                                                           //
//  PROJECT NAME..............test_scripts                                   //
//                                                                           //
//  TESTMODE..................FULLSCAN                                       //
//                                                                           //
//  INEXPERIMENT..............dff_atpg                                       //
//                                                                           //
//  TDR.......................dummy.tdr                                      //
//                                                                           //
...
//***************************************************************************//
  ...
  module test_scripts_FULLSCAN_dff_atpg ;
...
//***************************************************************************//
  ...
  reg [1:1] part_S_CR_1_TM_1;   

  wire [1:1] part_M_OR_1_TM_1;   
...
//***************************************************************************//
  ...
  dff
    dff_inst (
      .Q            ( part_POs [1] ),      // pinName = Q; 
      .scan_out     ( part_POs [2] ),      // pinName = scan_out;  tf =  SO  ; 
      .D            ( part_PIs [1] ),      // pinName = D; testOffset = 0.000000;  scanOffset = 0.000000;  
      .SE           ( part_PIs [2] ),      // pinName = SE;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      .clk          ( part_PIs [3] ),      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
      .rst          ( part_PIs [4] ),      // pinName = rst; testOffset = 0.000000;  scanOffset = 0.000000;  
      .scan_in      ( part_PIs [5] ));      // pinName = scan_in;  tf =  SI  ; testOffset = 0.000000;  scanOffset = 0.000000;  
...
//***************************************************************************//
  ...
  assign ( weak0, weak1 ) // Termination 
    part_POs [1] = global_term,     // pinName = Q; 
    part_POs [2] = global_term;      // pinName = scan_out;  tf =  SO  ; 


  assign ( supply0, supply1 ) // CR = 1 
    dff_inst.scan_in = part_S_CR_1_TM_1 [1] ;   // CR = 1;  pos = 1;  Pin Index = 4;  Pin Name = scan_in;  pinInvFromLatch = no;  Latch Index = 17;  Latch Name = Q_reg.U$1.i0.dff_primitive;   

  assign // OR = 1 
    part_M_OR_1_TM_1 [1] =  dff_inst.scan_out ;   // OR = 1;  pos = 1;  Pin Index = 6;  Pin Name = scan_out;  pinInvFromLatch = no;  Latch Index = 17;  Latch Name = Q_reg.U$1.i0.dff_primitive;   
...
//***************************************************************************//
  ...
  initial 
    begin 
      ...
      `ifdef sdf_annotate 
        `ifdef SDF_Minimum 
          $sdf_annotate ("default.sdf",dff_inst,,"sdf_Min.log","MINIMUM");
        `endif 
        `ifdef SDF_Maximum 
          $sdf_annotate ("default.sdf",dff_inst,,"sdf_Max.log","MAXIMUM");
        `endif 
        `ifdef SDF_Typical
          $sdf_annotate ("default.sdf",dff_inst,,"sdf_Typ.log","TYPICAL");
        `endif 
      `endif 
      ...
      if ( $test$plusargs ( "vcd" ) )  begin 
        $dumpfile("out.vcd"); 
        $dumpvars(0,test_scripts_FULLSCAN_dff_atpg ); 
      end  
...
//***************************************************************************//
  ...
  task sim_setup; 
    begin 
      ...
      SERIALCYCLE = 0; 
      SEQNUM = 0; 
      name_POs [1] = "Q";      // pinName = Q; 
      name_POs [2] = "scan_out";      // pinName = scan_out;  tf =  SO  ; 
  ...
  task test_cycle; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      part_PIs [1] = stim_PIs [1];      // pinName = D; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [2] = stim_PIs [2];      // pinName = SE;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
      part_PIs [4] = stim_PIs [4];      // pinName = rst; testOffset = 0.000000;  scanOffset = 0.000000;  
     ...
     #8.000000;        // 8.000000 ns;  From the start of the cycle.
      part_PIs [3] = stim_PIs [3];      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
     #8.000000;        // 16.000000 ns;  From the start of the cycle.
      part_PIs [3] = stim_CIs [3];      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
     #56.000000;        // 72.000000 ns;  From the start of the cycle.

      for ( POnum = 1; POnum <= 2; POnum = POnum + 1 ) begin 
        if (( part_POs [ POnum ] !== meas_POs [ POnum ] ) & ( meas_POs [ POnum ] !== 1'bX )) begin 
          ...
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "dff", name_POs [ POnum ], PATTERN, -1, part_POs [ POnum ] ); 
          end  
        end  
...
//***************************************************************************//
  ...
  task Scan_Preconditioning_Sequence_TM_1_SEQ_1_SOP_1; 
    begin 
      ...
      stim_PIs [2] = 1'b1;      // pinName = SE;  tf = +SE  ; testOffset = 0.000000;  scanOffset = 0.000000;  
...
//***************************************************************************//
  ...
  task Scan_Sequence_TM_1_SEQ_2_SOP_1; 
    begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      ...
      for ( SCANCYCLE = 1; SCANCYCLE <= MAX; SCANCYCLE = SCANCYCLE + 1 ) begin 
        ...
        if (( part_M_OR_1_TM_1 [ 0 + SCANCYCLE ] !== meas_OR_1 [ 0 + SCANCYCLE ] ) & ( meas_OR_1 [ 0 + SCANCYCLE ] !== 1'bX )) begin      // pinName = scan_out;  tf =  SO  ; 
          ...
          if (( failset ) & ( FAILSETID == 0 ))  failset_setup; 
          if ( FAILSETID ) begin 
            $fdisplay ( FAILSETID, " Chip %0s pad %0s pattern %0s position %0d value %0b ", "dff", name_POs [2], PATTERN, SCANCYCLE, part_M_OR_1_TM_1 [ 0 + SCANCYCLE ] ); 
          end  
        end  
        else  begin 
     ...
     #0.000000;        // 0.000000 ns;  From the start of the cycle.
      part_S_CR_1_TM_1 [1:1] = stim_CR_1 [1:1]; 
     #16.000000;        // 16.000000 ns;  From the start of the cycle.
      part_PIs [3] = 1'b1;      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
     #8.000000;        // 24.000000 ns;  From the start of the cycle.
      part_PIs [3] = 1'b0;      // pinName = clk;  tf = -ES  ; testOffset = 8.000000;  scanOffset = 16.000000;  
  ...
  task cmd_code; 
    begin 
      ...
      case ( CMD ) 
        ...
        202: begin 
          if ( rc_read > 0 )  begin 
            rc_read = $fscanf ( DATAID, "%b", meas_POs [1:2] ); 
            if ( rc_read <= 0 )  bad_cmd_code; 
            line_number = line_number + 1; 
          end  
        end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", stim_CR_1 [1:1] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
                ...
                if ( rc_read <= 0 )  bad_cmd_code; 
                  ...
                  case ( SCANNUM ) 
                    ...
                    1: begin 
                      ...
                      if ( rc_read > 0 )  begin 
                        rc_read = $fscanf ( DATAID, "%b", meas_OR_1 [1:1] ); 
                        if ( rc_read <= 0 )  bad_cmd_code; 
                        line_number = line_number + 1; 
                      end  
                    end  
        ...
        904: begin 
          ...
          if ( rc_read > 0 )  begin 
            `ifdef MISCOMPAREDEBUG 
              if ( diag_debug ) begin 
                $processSimulationDebugFile ( DIAG_DEBUG_FILE, "dff_inst", eventID ); 
              end 
            `endif 
          end  
          else  bad_cmd_code; 
