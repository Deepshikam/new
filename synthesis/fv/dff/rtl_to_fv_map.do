...
# Generated on: Wed May 08 17:12:52 IST 2024 (Wed May 08 11:42:52 UTC 2024)
...
set_log_file fv/dff/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/dff -revised fv_map
...
read_library -liberty -both /home/VLSI/new/synthesis/../lib/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/dff.v
elaborate_design -golden -root {dff} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/dff/fv_map.v.gz
elaborate_design -revised -root {dff}
...
#add_name_alias fv/dff/fv_map.singlebit.original_name.alias.json.gz -revised
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/dff/rtl_to_fv_map.log
}
