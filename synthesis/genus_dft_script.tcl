...
check_dft_rules 
set_db design:dff .dft_min_number_of_scan_chains 1 
...
write_hdl > outputs/dff_netlist_dft.v
write_sdc > outputs/dff_sdc_dft.sdc
write_sdf -nonegchecks -edges check_edge -timescale ns -recrem split  -setuphold split > outputs/dft_delays.sdf
write_scandef > outputs/dff_scanDEF.scandef
