...
set_db init_netlist_files ../physical_design/openMSP430_netlist.v
set_db init_lef_files {../lef/gsclib045_tech.lef ../lef/gsclib045_macro.lef}
set_db init_power_nets VDD
set_db init_ground_nets VSS
set_db init_mmmc_files  openMSP430.view
read_mmmc openMSP430.view
read_physical -lef {../lef/gsclib045_tech.lef ../lef/gsclib045_macro.lef}
read_netlist ../physical_design/openMSP430_netlist.v -top openMSP430
init_design
...
#Pin Assignment
write_io_file -template pins1.io
read_io_file pins1.io
