...
#  Generated on:      Wed May  8 17:57:35 2024
#  Design:            dff
...
set_preference attribute_summary_rc_corner "cap_table_file is_active is_dynamic is_hold is_leakage is_setup name obj_type post_route_cap post_route_clock_cap post_route_clock_res post_route_cross_cap post_route_res pre_route_cap pre_route_clock_cap pre_route_clock_res pre_route_res qrc_tech_file temperature via_variation_file"
...
set_preference attribute_summary_pg_pin "base_name escaped_name inst name net obj_type pg_base_pin route_max_fanout"
...
set_preference attribute_summary_bump "base_cell base_name bbox bump_pins center escaped_name is_fixed_assignment location name net obj_type orient place_status ports"
...
set_preference attribute_summary_hinst "area base_name bbox boundary dont_touch dont_touch_effective dont_touch_hports dont_touch_sources dont_use_cells dont_use_cells_effective escaped_name group hinsts hnets hpins hports ilm_inst insts is_ilm local_hinsts local_hnets local_hpins local_insts local_pins module name obj_type parent partition power_domain power_dynamic power_internal power_leakage power_switching power_toggle_rate power_total read_only read_only_effective use_cells"
set_preference attribute_summary_route_rule "is_from_lib is_hard_spacing layer_rules min_cuts name obj_type via_defs"
set_preference attribute_summary_hpin "base_name constant depth direction dont_touch dont_touch_effective dont_touch_sources escaped_name hinst hnet hport location name net obj_type place_status side width"
...
set_preference attribute_summary_lib_arc "aocv_weight base_name from_lib_pin full_name has_socv is_disabled lib_cell mode name obj_type sdf_cond sense timing_type to_lib_pin when when_end when_library_string when_start"
...
set_preference attribute_summary_module "allow_ilm_eco design dont_touch dont_touch_hports dont_use_cells dont_use_cells_effective hinsts is_ilm name obj_type use_cells"
